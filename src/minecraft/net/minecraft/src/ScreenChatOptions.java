...
import tw.davy.skinmod.src.GuiSkinServerList;
...
public class ScreenChatOptions extends GuiScreen
{
    ...
    public void initGui()
    {
        ...
        tw.davy.skinmod.src.StringTranslate skinmodTranslate = tw.davy.skinmod.src.StringTranslate.getInstance();
        skinmodTranslate.setLanguage(var1.getCurrentLanguage(), false);
        int var2 = 0;
        ...
        this.buttonList.add(new GuiSmallButton(201, this.width / 2 - 155 + var2 % 2 * 160, this.height / 6 + 24 * (var2 >> 1), skinmodTranslate.translateKey("gui.skinlist.title")));
    ...
    protected void actionPerformed(GuiButton par1GuiButton)
    {
        if (par1GuiButton.enabled)
        {
            ...
            {
                this.mc.gameSettings.saveOptions();
                this.mc.displayGuiScreen(new GuiSkinServerList(this));
            }
        }
    }
