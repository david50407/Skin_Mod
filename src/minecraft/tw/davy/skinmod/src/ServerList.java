...
{
	public static String datFilename = "tw.davy.skinmod.servers.dat";
    ...
    public ServerList()
    {
        this.datFile = new File(Minecraft.getMinecraftDir(), datFilename);
    ...
    public void loadServerList()
    {
        ...
        try
        {
            NBTTagCompound var1 = CompressedStreamTools.read(this.datFile);
    ...
    public void saveServerList()
    {
        try
        {
            ...
            CompressedStreamTools.safeWrite(var5, this.datFile);
        }
        catch (Exception var4)
        {
            var4.printStackTrace();
    ...
    {
    	ServerData var3 = this.getServerData(par2);
    	this.servers.set(par2, this.getServerData(par1));
    	this.servers.add(par1, var3);
        this.saveServerList();
    }
    ...
    {
        ServerList var1 = new ServerList();
        var1.loadServerList();
        ...
        for (int var2 = 0; var2 < var1.countServers(); ++var2)
        {
            ...
            if (var3.serverName.equals(par0ServerData.serverName) && 
            		var3.serverSkinURI.equals(par0ServerData.serverSkinURI) &&
            		var3.serverCloakURI.equals(par0ServerData.serverCloakURI))
            {
